...
public class RegisterApiController {
    ...
    public ResponseEntity create(@RequestBody RegisterRequest request) throws URISyntaxException {

        User user = registerService.registerUser(request);
        String url = "/register/"+user.getId();
